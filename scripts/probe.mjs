...
await page.screenshot({ path: "/tmp/effx-verify/00-initial.png" })
...
await page.screenshot({ path: "/tmp/effx-verify/01-after-3-clicks.png" })
...
await page.screenshot({ path: "/tmp/effx-verify/02-after-reset.png" })
...
writeFileSync("/tmp/effx-verify/console.log", consoleLog.join("\n"))
