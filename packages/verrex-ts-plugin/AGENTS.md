...
live in [`verrex/language`](../language/AGENTS.md) — shared with
`verrex/check`.
...
[`verrex/language`](../language/AGENTS.md). Read that node for the full
...
`extraFileExtensions` registered by [`verrex/language`](../language/AGENTS.md),
...
- Don't switch `extraFileExtensions.scriptKind` /
  ...
  [`verrex/language` AGENTS.md](../language/AGENTS.md#the-extrafileextensions-shape-is-load-bearing).
...
- [`verrex`](../runtime/AGENTS.md) — the `_tag/_props/_children`
  parameter naming
- [`verrex/compiler`](../compiler/AGENTS.md) — the source-location
  preservation that the source map depends on
- [`verrex/language`](../language/AGENTS.md) — the shared Volar
