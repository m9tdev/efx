...
import type { FoldE, FoldR } from "./types/Fold.ts"
...
export const h: <Cs extends readonly unknown[]>(
  tag: string | ((props: any) => Effect.Effect<View, any, any>),
  props: Props,
  ...children: Cs
) => Effect.Effect<View, FoldE<Cs>, FoldR<Cs>> = _h as never
