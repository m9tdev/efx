...
| `reader.ts`            | The ambient reader: the `null`-frame stack, `get`, the guarded readable behind `h.reader`, `readSource` (Atom/AtomRef/plain through a registry get), `guardRegistryRead` (throw → `Effect.die`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
